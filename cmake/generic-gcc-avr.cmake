...
function(add_avr_executable EXECUTABLE_NAME)
   ...
   set_target_properties(
      ...
      PROPERTIES
         ...
         LINK_FLAGS "-mmcu=${AVR_MCU} -mrelax -Wl,-Map,${map_file},--gc-sections,--section-start=.bootloader=0x1E00"
   )

   add_custom_command(
      OUTPUT ${hex_file}
      COMMAND
         ${AVR_OBJCOPY} -j .bootloader -j .text -j .data -O ihex ${elf_file} ${hex_file}
      COMMAND
   ...
   add_custom_command(
      OUTPUT ${bin_file}
      COMMAND
         ${AVR_OBJCOPY} -R .bootloader -O binary ${elf_file} ${bin_file}
      DEPENDS ${elf_file}
   )
